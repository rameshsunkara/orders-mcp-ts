...
import { ClientOptions } from 'ordersapi';
...
export { ClientOptions } from 'ordersapi';
...
export function initMcpServer(params: {
  ...
  const client = new Ordersapi(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Ordersapi({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
